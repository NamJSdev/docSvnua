    ...
    <div class="min-height-200px">
        ...
        <div class="card-box mb-30">
            <div class="pd-20 d-flex flex-wrap align-items-center justify-content-between mb-4">
                <h4 class="text-blue h4">Quản Lý Bài Đăng</h4>
            </div>
            <div class="pb-20">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <a class="dropdown-item" href="{{ asset('storage/' . $data->doc->docLink) }}"
                                                target="_blank" data-id="{{ $data->id }}"><i class="fa fa-eye"></i> Xem
                                                Tài Liệu</a>
                                            <a class="dropdown-item delete" href="#" href="#" title="Delete"
                                                data-toggle="modal" data-target="#deleteModal"
                                                data-id="{{ $data->id }}"><i class="fa fa-trash"></i> Xóa</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
    ...
    <div id="deleteModal" class="modal fade" >
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="deleteForm" method="POST" action="{{ route('posts.delete') }}">
                    @csrf
