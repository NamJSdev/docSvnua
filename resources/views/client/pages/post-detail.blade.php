...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row blog-entries element-animate">
                ...
                <div id="pdf-viewer">
                    ...
                    <iframe src="{{ $pdfUrl }}#page=1" style="width: 100%; height: 100%; border: none;" id="pdf-frame"></iframe>
                </div>
                    <div class="pt-5">
                        <p>Chủ đề: &nbsp;<a
                ...
                <div class="col-md-12 col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            ...
                            <div class="bio-body">
                                <h2>{{$post->account->info->name}} <span style="font-size: 16px !important">({{$post->account->info->role}})</span></h2>
                                <p class="mb-4">{{$post->account->info->desc}}</p>
                                <p><a href="{{ route('account-user', ['accountID' => $post->account->id]) }}" class="btn btn-primary btn-sm rounded px-2 py-2">Xem Profile</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- END sidebar-box -->
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('post-detail', ['postID' => $post->id]) }}">
                                        ...
                                        <div class="text">
                                            <h4 class="text-limit" title="{{$post->name}}">{{$post->name}}</h4>
                                        </div>
                                    </a>
                                </li>
                                @endforeach
                    ...
                    <div class="sidebar-box">
                        ...
                        <ul class="categories">
                            ...
                            <li><a href="{{ route('post-client.category', ['categoryID' => $category->id]) }}">{{ $category->name }}<span>({{ $category->posts_count }})</span></a></li>
                            @endforeach
                        </ul>
                    </div>
                    <!-- END sidebar-box -->
    ...
    <style>
        ...
        #pdf-viewer {
            height: 100vh; /* Chiều cao của khu vực PDF Viewer */
            overflow: hidden;
        }
        #pdf-frame {
            width: 100%;
