                    ...
                    <div class="col-lg-6 text-center">
                        ...
                        <form action="{{ route('search') }}" method="GET" class="search-form d-none d-lg-inline-block">
                            <div class="input-group">
                                <input type="text" name="query" class="form-control mt-0" placeholder="Tìm kiếm bài viết hoặc danh mục..." value="{{ request()->input('query') }}">
                                <div class="input-group-append">
                                    <button class="btn btn-primary mt-0 d-flex align-items-center" type="submit" style="height: 80%">Tìm Kiếm</button>
                                </div>
                            </div>
                        </form>
                    </div>
